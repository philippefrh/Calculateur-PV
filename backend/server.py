...
async def generate_solar_panel_visualization(image_data: str, kit_power: int, region: str = "france") -> Dict[str, Any]:
    """
    Generate photorealistic solar panel visualization using fal.ai
    ...
    try:
        ...
        if not fal_key:
            return {
                "success": False,
                "error_message": "FAL_KEY not configured in environment"
            }
...
IMPORTANT: The result must look identical to professional solar installation photos with perfect photorealistic quality."""
        ...
        if result and 'images' in result and len(result['images']) > 0:
            ...
            return {
                "success": False,
                "error_message": "No image generated by fal.ai"
            }
