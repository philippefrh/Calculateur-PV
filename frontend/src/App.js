              ...
              {(results.discount_applied > 0 || results.battery_selected) ? (
                <>
                  ...
                  {results.battery_selected && (
                    <span className="battery-badge" style={{background: '#2ecc71', color: 'white', padding: '2px 6px', borderRadius: '4px', fontSize: '10px', marginLeft: '8px'}}>
                      +Batterie {results.battery_cost}€
                    </span>
                  )}
                </>
              ) : (
          ...
          <div className="financing-section">
            ...
            <div className="amortization-table-section">
              ...
              <div className="amortization-container">
                {/* En-tête organismes - EXACTEMENT comme votre ancien logiciel */}
                ...
                {/* Structure principale - POSITIONS EXACTES de l'ancien logiciel */}
                <div className="amortization-main">
                  
                  {/* Installation - Position gauche */}
                  ...
                  {/* 3 mois = 0€ - Position centre */}
                  <div className="months-box">
                    3 mois = 0€
                  </div>
                  
                  {/* Mensualité initiale - Position droite */}
                  ...
                  {/* Flèches directionnelles - POSITIONS EXACTES */}
                  ...
                  {/* Ligne principale avec les 5 cases - REPRODUCTION EXACTE */}
                  ...
                  {/* Ligne du bas avec les 4 cases - REPRODUCTION EXACTE */}
                  ...
                  {/* Section ÉCO-FINANCEMENT - POSITION EXACTE à droite */}
...
const CalculationScreen = ({ formData, onComplete, onPrevious, selectedRegion = "france", selectedCalculationMode = "optimistic", setCurrentStep }) => {
  ...
  const [autoCountdown, setAutoCountdown] = useState(7);
