...
// Composant pour afficher les résultats professionnels avec leasing
const ProfessionalResults = ({ results }) => {
  const optimalKit = results.optimal_kit;
  const leasingOptions = results.leasing_options || [];
        ...
        <div className="optimal-kit-section">
          ...
          <div className="optimal-kit-card">
            <div className="optimal-kit-header">
              <h4>Kit {optimalKit.kit_power}kW - Leasing {optimalKit.duration_months} mois</h4>
            ...
            <div className="optimal-kit-details">
              <div className="optimal-detail-row">
                ...
                <span className="leasing-payment">{optimalKit.monthly_payment?.toFixed(2)}€/mois</span>
              </div>
              <div className="optimal-detail-row">
                <span>Économies mensuelles :</span>
                <span className="monthly-savings">{optimalKit.monthly_savings?.toFixed(2)}€/mois</span>
              </div>
              <div className="optimal-detail-row benefit">
                <span>Bénéfice mensuel :</span>
                <span className="monthly-benefit">+{optimalKit.monthly_benefit?.toFixed(2)}€/mois</span>
              </div>
            </div>
          </div>
        </div>
